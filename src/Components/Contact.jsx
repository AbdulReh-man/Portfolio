...
const Contact = () => {
  ...
  const {
    ...
    onSubmit: (values) => { 
      ...
      emailjs
        .sendForm('service_ukuita2', 'template_g05vcm6', form.current,'aEEUeDX7fRHj3x_Rv'
        )
        .then(
          () => {
  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col overflow-hidden flex text-white md:w-full gap-x-14">
     ...
     <motion.div
      ...
      >
        <div className="bg-black-100 p-8 rounded-2xl ">
          ...
          <form ref={form} onSubmit={handleSubmit} noValidate className="flex flex-col mt-12 space-y-4 ">
      ...
      <motion.div
        ...
        className="flex-[0.4] flex justify-center items-end">
